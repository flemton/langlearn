// Centralized lesson data - Single source of truth
    ...
    lessons: [
      ...
      },
      {
        ...
        content: [
          ...
          { type: 'vocabulary', word: 'أريد ماء', pronunciation: 'ureedo ma\'', meaning: 'I want water' },
...
// Helper functions
export const getLanguageData = (language: string): LanguageData | null => {
  return languageData[language.toLowerCase()] || null;
};

export const getLesson = (language: string, lessonId: number): Lesson | null => {
  const langData = getLanguageData(language);
  if (!langData) return null;
  return langData.lessons.find(l => l.id === lessonId) || null;
};
